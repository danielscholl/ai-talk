...
- Create an agent using the OpenAI Agents SDK with Azure OpenAI
- Set up proper authentication using Azure OpenAI credentials
...
- Add the agent to the readme with a basic description of the agent including a mermaid sequence diagram, how to run it and execute tests
